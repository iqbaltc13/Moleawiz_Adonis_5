...
class ReminderController {
  ...
  index = async ({auth,request, response, view, params, session}) => {
    ...
    let course = await DaaCourse.query().where('id',id).first();


    return view.render('dashboard.journey.course.reminder.index_new',{ authUser : authUser,  datas : datas , course : course })
   ...
   create = async ({auth,request, response, view, params, session}) => {
    const authUser = auth.user.toJSON();
    let id = params.course_id;
    let course    = await DaaCourse.query().with('journey').where('id',id).first();
    return view.render('dashboard.journey.course.reminder.create',{authUser : authUser, course : course });
  ...
  store = async ({auth,request, response, view, params, session}) => {
    ...
    return  response.route('dashboard.journey.course.reminder.index',{course_id : data.course_id})
  ...
  edit = async ({auth,request, response, view, params, session}) => {
    ...
    const data     = await DaaReminder
                    ...
                    .where('id',id)
                    .first();
    return view.render('dashboard.journey.course.reminder.edit',{authUser : authUser,data:data});
  ...
  switchVisible = async ({auth,request, response, view, params, session}) => {
    ...
    response.route('dashboard.journey.course.reminder.index',{course_id : data.course_id});
  ...
  indexSetting = async ({auth,request, response, view, params, session}) => {
    ...
    const reminder    = await DaaReminder.query()
                        ...
                        .where('id',id)
                        .first()
    return view.render('dashboard.journey.course.reminder.setting.index',{ authUser : authUser,  datas : datas, reminder : reminder})
  ...
  createSetting = async ({auth,request, response, view, params, session}) => {
    ...
    const authUser = auth.user.toJSON()
    return view.render('dashboard.journey.course.reminder.setting.create',{authUser : authUser,reminder : reminder});
  }
  ...
  storeSetting = async ({auth,request, response, view, params, session}) => {
    ...
    return response.route('dashboard.journey.course.reminder.setting.index',{reminder_id: request.input('reminder_id')})
  ...
  editSetting = async ({auth,request, response, view, params, session}) => {
    ...
    const data     = await DaaReminderSetting.query()
                    .with('reminder', (builder) => {
                      builder.with('journey').with('course')  
                    })
                    .with('reminder_logs')
                    //.whereNull('deleted_at')
                    .where('id', id)
    ...
    return view.render('dashboard.journey.course.reminder.setting.edit',{authUser : authUser,data: data});
  ...
  updateSetting = async ({auth,request, response, view, params, session}) => {
    ...
    return response.route('dashboard.journey.course.reminder.setting.index',{reminder_id: data.reminder_id})
  ...
  importForm = async ({auth,request, response, view, params, session})=> {
    ...
    return view.render('dashboard.journey.course.reminder.setting.import_form',{authUser : authUser,data: data, datas : []});
  }
  ...
  async import({auth,request, response, view, params, session}){
    ...
    return view.render('dashboard.journey.course.reminder.setting.import_form',{authUser : authUser,data: data, datas : send});
  }
