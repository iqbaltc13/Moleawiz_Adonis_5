...
class MonthToDateSummaryLearningCompletionController {
  ...
  async report({ view, auth, response, request, session, params }) {
    ...
    let enrolStartDate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+'01';
    let enrolEndDate = date;
    let journey = {};
    ...
    let paramsExport = {};
    paramsExport.filename = "Month_To_Date_Summary_Learning_Completions_";
    paramsExport.table_heads_additional = [];
    paramsExport.table_heads_end = [];
    let reportType = "Month To Date Summary Learning Completions ";
    ...
    daaFileExport.type        = "export_month_to_date_summary_learning_completions";
...
module.exports = MonthToDateSummaryLearningCompletionController
