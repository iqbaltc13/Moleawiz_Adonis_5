...
class SummaryLearningCompletionController {
  ...
  async report({ view, auth, response, request, session, params }) {
    ...
    let paramsExport = {};
    paramsExport.filename = "Summary_Learning_Completions_";
    paramsExport.table_heads_additional = [];
    paramsExport.table_heads_end = [];
    let reportType = "Summary Learning Completions ";
    let sqlEnrollmentData = "SELECT uid1.data AS directorate "+
          ...
          "INNER JOIN user_info_data uid2 ON uid2.userid = u.id AND uid2.fieldid=2 "+
           ...
           if ('0' != request.input('subdirectorateid') && '' != request.input('subdirectorateid')) {
    ...
    daaFileExport.type        = "export_summary_learning_completions";
...
module.exports = SummaryLearningCompletionController
