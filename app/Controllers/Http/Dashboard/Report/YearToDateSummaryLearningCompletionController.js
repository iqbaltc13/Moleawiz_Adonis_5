...
class YearToDateSummaryLearningCompletionController {
  ...
  async report({ view, auth, response, request, session, params }) {
    ...
    let paramsExport = {};
    paramsExport.filename = "Year_To_Date_Summary_Learning_Completions_";
    paramsExport.table_heads_additional = [];
    paramsExport.table_heads_end = [];
    let reportType = "Year To Date Summary Learning Completions ";
    ...
    daaFileExport.type        = "export_year_to_date_summary_learning_completions";
...
module.exports = YearToDateSummaryLearningCompletionController
