(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      btnRemoveText: " <i class='mdi mdi-account-minus'></i> Remove Learner",                                                              // string, sets the text for the "Remove" button
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '   <label class="label-box" style="font-size: 16px;"></label>' +
        '   <br/>' +
        '   <span class="info-container">' +
        '     <span class="info"></span>' +
        '     <button type="button" class="btn btn-sm clear1" style="float:right!important;"></button>' +
        '   </span>' +
        '   <input class="form-control filter " type="text" id="filter-box-2" >' +
        //'  &#160; ' +

        '   <select multiple="multiple" class="pt-2" ></select>' +
        //'   <br/>' +
        '   <div class="btn-group buttons" style="padding-top:5px;">' +
        '     <button type="button" class="btn btn-danger set-main-admin">Set Main Admin</button> &#160; &#160;' +
        '     <button type="button" class="btn remove btn-danger"></button>' +
        '     <button   style="display: none;"  type="button" class="btn removeall"></button>' +
        '   </div>' +
        ' </div>' +
        ...
        '   </span>' +
        '   <input class="form-control filter " type="text" id="filter-box-1" >' +
        //'     &#160;' +
        '   <select multiple="multiple" class="pt-2" ></select>' +
       // '   <br/>' +
        '   <div class="btn-group buttons" style="padding-top:5px;">' +
        '     <button style="display: none;" type="button" class="btn moveall"></button>' +
        '     <button type="button" class="btn move btn-danger"></button>' +
        '   </div>' +
        ' </div>' +
        '</div>')
